      ...
      <Card className="bg-black/10 backdrop-blur-sm border-black/20">
        ...
        <CardContent>
          <div className="flex items-center gap-2">
            <input className="bg-black/20 border border-black/30 rounded px-2 py-1 text-white" placeholder="my_username" value={username} onChange={e=>setUsername(e.target.value)} />
            <Button disabled={!username || busy} onClick={()=>{ setOpen(true); setTimeout(handleStart, 500); }}>Start</Button>
